...
const Reels = () => {
  ...
  // 🔁 Optional: track last video loaded
  useEffect(() => {
    if (videos.length > 0) {
      ...
      // 🔁 You can trigger additional fetches here
            ...
            videos.map((video: any, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  {/* 📱 Icon menu - scrolls with video */}
                  <div className="absolute  lg:bottom-10 right-20 translate-x-full p-4 z-50">
                    <div className="menu bg-base-200 rounded-box text-3xl flex flex-col gap-4 p-2">
